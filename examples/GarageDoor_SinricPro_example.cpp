...
#define MOVE_TIMEOUT      5000 // Timout (60 seconds) for door movement -> please use a value which fits to your open/close time
#define RELAY_TIME        500  // Relay high time (4 seconds) - usually between 2500 and 5000
...
int lastDoorState = getDoorState(); // last known doorstate
